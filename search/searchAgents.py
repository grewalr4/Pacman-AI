...
def cornersHeuristic(state, problem):
    ...
    for corner in unvisited:
        estimate = mazeDistance(position, corner, problem.startingState)
...
def foodHeuristic(state, problem):
    ...
    for food in foodList:
        estimate = mazeDistance(position, food, problem.startingState)
        if estimate > maxEstimate:
            maxEstimate = estimate
...
class ClosestDotSearchAgent(SearchAgent):
    ...
    def findPathToClosestDot(self, gameState):
        ...
        "*** YOUR CODE HERE ***"
        return search.generalSearch(problem, heuristic=manhattanHeuristic, search="astar")
...
class AnyFoodSearchProblem(PositionSearchProblem):
    ...
    def __init__(self, gameState):
        ...
        for food in self.food.asList():
            distance = mazeDistance(self.startState, food, gameState)
